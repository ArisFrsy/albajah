        ...
        return (
            <main className="flex-1 p-6 bg-muted/40 flex items-center justify-center min-h-screen">
                <div className="text-center">
                    <h2 className="text-2xl font-semibold text-foreground mb-2">Data Tidak Ditemukan</h2>
                    <p className="text-muted-foreground mb-6">Sub Paket yang Anda cari tidak ada atau telah dihapus.</p>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-300 min-h-[calc(110vh-7rem)]">
                ...
                <Card>
                    ...
                    <CardContent className="p-6 space-y-8">
                        ...
                        <section>
                            <h3 className="text-lg font-semibold text-foreground mb-4">Informasi Paket & Harga</h3>
